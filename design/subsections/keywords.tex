...
SDIR contains only two additional types on top of the builtin types: \codeword{!sdir.memlet<>} (See Section \ref{section:memlet}) and \codeword{!sdir.stream<>} (See Section \ref{section:stream}).
