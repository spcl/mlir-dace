...
Every op and region in SDIR is prefixed by the keyword \codeword{sdir} followed by a dot to clearly mark the end of the prefix. Some examples are: \codeword{sdir.tasklet\{\}}, \codeword{sdir.return\{\}}, \codeword{sdir.alloc()}. \\
